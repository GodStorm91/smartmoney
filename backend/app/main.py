...
from .routes import accounts, analytics, auth, budgets, category_rules, credits, dashboard, goals, receipts, recurring, settings, tags, transactions, upload, exchange_rates, user_categories

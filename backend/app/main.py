...
from .routes.mcp_token import router as mcp_token_router, write_router as mcp_write_token_router
...
app.include_router(mcp_write_token_router)
...
app.include_router(budget_alerts_router)  # Must be before budgets_router (/{month} catches /alerts)

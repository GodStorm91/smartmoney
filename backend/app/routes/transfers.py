...
from app.schemas.transfer import TransferCreate, TransferResponse, TransferListItem
...
async def create_transfer(
    ...
    out_tx = Transaction(
        ...
        currency=from_account.currency or "JPY",
        category="Transfer",
    ...
    in_tx = Transaction(
        ...
        currency=to_account.currency or "JPY",
        category="Transfer",

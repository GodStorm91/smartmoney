    ...
    <div ref={cardRef} className="relative overflow-hidden">
          ...
          >
            <div className="py-2">
              ...
              >
                ...
                <span className="text-gray-900 dark:text-gray-100">{t('button.copy', 'Copy')}</span>
              </button>
              ...
              >
                ...
                <span className="text-red-600 dark:text-red-400">{t('button.delete', 'Delete')}</span>
              </button>
            </div>
          </div>
        </div>
      ...
      >
        <button
          ...
          aria-label={t('transaction.deleteTransaction', 'Delete transaction')}
        >
          <svg
          ...
          <span className="text-xs font-medium">{t('button.delete', 'Delete')}</span>
        </button>
      </div>

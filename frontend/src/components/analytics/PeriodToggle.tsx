    ...
    >
      {PERIODS.map(({ value, labelKey }) => (
        <button
          ...
          className={cn(
            'px-3 py-2.5 sm:py-1.5 min-h-[44px] sm:min-h-0 text-sm font-semibold rounded-md transition-all duration-200',
            value === selected
              ? 'bg-white dark:bg-gray-700 text-primary-700 dark:text-primary-300 shadow-md ring-1 ring-primary-200 dark:ring-primary-800'

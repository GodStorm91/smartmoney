    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="flex justify-between items-center mb-6">
          ...
          <Button variant="outline" size="sm" onClick={() => setShowWalletForm(!showWalletForm)}>
            {showWalletForm ? t('cancel') : t('crypto.addWallet')}
          </Button>
        </div>
        ...
        {showWalletForm && (
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-4">
            ...
            <Button
              ...
              className="w-full"
            >
              {createWalletMutation.isPending ? t('loading') : t('crypto.addWallet')}
            </Button>
          </div>
        )}
      ...
      <Card>
        <div className="flex justify-between items-center mb-6">
          ...
          >
            {showContractForm ? t('cancel') : t('crypto.addContract')}
          </Button>
        </div>
        ...
        {showContractForm && (
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-4">
            ...
            <Button
              ...
              className="w-full"
            >
              {createContractMutation.isPending ? t('loading') : t('crypto.addContract')}
            </Button>
          </div>
        )}

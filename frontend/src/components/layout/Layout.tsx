  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <button
        ...
        className="fixed bottom-[calc(9rem+env(safe-area-inset-bottom,0px))] right-4 md:bottom-6 md:right-6 z-50 p-4 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-lg transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"

      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{formatFileSize(item.file.size)}</p>
            ...
            {item.status === 'success' && item.backendResult && (
              <div className="mt-2 text-xs text-gray-600 dark:text-gray-400">
                <span className="text-green-600 dark:text-green-400 font-medium">{item.backendResult.created}</span> {t('upload.created')},
                <span className="ml-1 text-gray-500 dark:text-gray-400">{item.backendResult.skipped}</span> {t('upload.skipped')}
              </div>
            )}

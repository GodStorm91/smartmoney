...
import { ASSET_TYPES, convertToJpy } from '@/utils/netWorthCalc'
...
export function KpiRow({ summary, formatCurrency, accounts, exchangeRates = {} }: KpiRowProps) {
  ...
  const kpis = [
    { label: t('dashboard.assets', 'Assets'), value: assets, color: 'text-income-600 dark:text-income-300' },
    { label: t('dashboard.liabilities', 'Liabilities'), value: liabilities, color: 'text-expense-600 dark:text-expense-300' },
    { label: t('nav.transactions', 'Transactions'), value: summary?.transaction_count || 0, color: 'text-gray-900 dark:text-gray-100', isCount: true },
  ]

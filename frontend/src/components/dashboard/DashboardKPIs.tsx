  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4">
      <KPICard
        ...
        icon={
          <svg className="w-6 h-6 text-net-600 dark:text-net-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <Link to="/transactions" search={{ type: 'income' }} className="block">
        <KPICard
          ...
          clickable
          icon={
            <svg className="w-6 h-6 text-income-600 dark:text-income-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <Link to="/transactions" search={{ type: 'expense' }} className="block">
        <KPICard
          ...
          clickable
          icon={
            <svg className="w-6 h-6 text-expense-600 dark:text-expense-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">

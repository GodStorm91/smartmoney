        ...
        {showBreakdown && (
          <div className="mt-4 pt-4 border-t border-gray-200 text-sm">
            <div className="flex justify-between mb-2">
              <span className="text-gray-600">{t('dashboard.assets', 'Assets')}</span>
              <span className="font-numbers text-green-600">
                {formatCurrencyPrivacy(assets, currency, rates, false, isPrivacyMode)}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">{t('dashboard.liabilities', 'Liabilities')}</span>

...
import { Plus, Upload, Camera, TrendingUp, Wallet, Target } from 'lucide-react'
          ...
          if (action.to) {
            return (
              <Link
                key={index}
                to={action.to}
                className="flex-shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded-xl p-0.5"
              >
                {content}
              </Link>
            )

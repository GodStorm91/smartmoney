        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Your Money, Your Rules, <span className="text-blue-200">Your Server</span>
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                <Brain className="h-5 w-5 text-blue-300 flex-shrink-0" />
                <span className="text-sm">AI-Powered Budgets</span>
              </div>
              <div className="flex items-center gap-3">
                <TrendingUp className="h-5 w-5 text-blue-300 flex-shrink-0" />
          ...
          <div className="relative">
            <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="aspect-video bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-blue-200 text-sm mt-2">Privacy mode enabled</p>
                </div>
              </div>
              ...
              <div className="absolute -bottom-6 left-8 right-8 bg-white rounded-lg shadow-xl p-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-blue-700">0.36</div>
